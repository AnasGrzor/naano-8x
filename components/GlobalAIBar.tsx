...
export function GlobalAIBar() {
  return (
    <div className="pointer-events-none fixed inset-x-0 bottom-6 z-50 flex justify-center px-4">
      <div className="pointer-events-auto flex h-11 w-full max-w-[420px] items-center gap-2 rounded-full border border-border bg-background/95 pr-1.5 pl-4 shadow-lg backdrop-blur-sm">
